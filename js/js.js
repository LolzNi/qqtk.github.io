...
function reg_u_koshelek(){
var reg_u_koshelek=document.getElementById('u_koshelek').value;
reg_u_qiwi=reg_u_qiwi.replace(/[^0-9]+/g,"");
document.getElementById('u_koshelek').value=reg_u_koshelek;
}
...
function batch2() {
document.getElementById('batch').value=document.getElementById('batch').value.replace(/[^a-zA-Z\-\_0-9]+/g,'');
}
